fluidRow(
  ...
  column(width = 6,class="animated bounceInRight",
         div(class="main-wrap",
                   ...
                   sliderInput("slider01", "Gennemsnitlig årlig vækst (%)", min = -10, max = +10, value = 1.7, step = 0.1, animate = animationOptions(interval = 600, loop = TRUE)),
                   sliderInput("slider02", "Eskport priselasticitet (%)", min = -20, max = +20, value = -5, step = 0.1, animate = animationOptions(interval = 600, loop = TRUE)),
