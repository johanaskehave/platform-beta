...
wellPanel(style = "background-color: #ffffff;",
          ...
          h3("Hvordan kan beskæftigelsen påvirkes ved at øge de offentlige ansattes arbejdstid?"),
          
          h4("Dette spørgsmål er relevant at undersøge som baggrund for de overenskomstforhandlinger, som skal genforhandles 1. april 2018. Analysen vil være et centralt element i debatten, hvorfor det er essentielt, at samtlige beregninger og forudsætninger er tilgængelige for offentligheden."), 
